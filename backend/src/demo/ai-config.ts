...
export const DEMO_TTS_CONFIG = {
  maxCharsPerSession: parseInt(process.env.DEMO_TTS_MAX_CHARS_PER_SESSION ?? '4000', 10),
  maxCallsPerSession: parseInt(process.env.DEMO_TTS_MAX_CALLS_PER_SESSION  ?? '15',  10),
  allowedMessageTypes: (
