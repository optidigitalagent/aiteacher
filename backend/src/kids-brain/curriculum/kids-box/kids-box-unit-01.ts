...
const LESSON_2_EXERCISES: KidsExerciseDefinition[] = [
  ...
  },
  {
    ...
    nextExerciseId: 'kb1-u01-l02-ex-06b-pink',
    requiresVisualUI: false,
    allowedWithoutVisualUI: true,
    tags: ['listen-and-repeat', 'colour-yellow', 'unit1', 'kb1-u01-l02'],
  },
  // ── Phase 1 fix: pink, purple, orange Listen & Repeat (previously missing) ──
  {
    exerciseId: 'kb1-u01-l02-ex-06b-pink',
    lessonId: 'kb1-u01-l02',
    order: 6,
    pageRef: 'PB p.6',
    textbookActivityType: KidsTextbookActivityType.LISTEN_AND_REPEAT,
    studentActionType: KidsStudentActionType.REPEAT_WORD,
    targetItemIds: ['KB1-U01-COL-003'],
    teacherInstruction: 'Listen. Pink. Say pink!',
    prompt: { text: 'Listen — pink! Now you!', ttsText: 'Listen — pink! Now you say it!' },
    choices: [],
    ...
    nextExerciseId: 'kb1-u01-l02-ex-07b-purple',
    requiresVisualUI: false,
    allowedWithoutVisualUI: true,
    tags: ['listen-and-repeat', 'colour-pink', 'unit1', 'kb1-u01-l02'],
  },
  {
    exerciseId: 'kb1-u01-l02-ex-07b-purple',
    lessonId: 'kb1-u01-l02',
    order: 7,
    pageRef: 'PB p.6',
    textbookActivityType: KidsTextbookActivityType.LISTEN_AND_REPEAT,
    studentActionType: KidsStudentActionType.REPEAT_WORD,
    targetItemIds: ['KB1-U01-COL-004'],
    teacherInstruction: 'Listen. Purple. Say purple!',
    prompt: { text: 'Listen — purple! Now you!', ttsText: 'Listen — purple! Now you say it!' },
    choices: [],
    expectedAnswers: ['purple'],
    audioPromptPayload: {
      assets: [{ assetId: 'kb1-u01-colour-purple-tts', assetType: 'tts_prompt', available: true }],
    },
    completionRule: {
      type: KidsCompletionRuleType.CORRECT_REPETITIONS,
      requiredCorrectCount: 2,
    ...
    nextExerciseId: 'kb1-u01-l02-ex-08b-orange',
    requiresVisualUI: false,
    allowedWithoutVisualUI: true,
    tags: ['listen-and-repeat', 'colour-purple', 'unit1', 'kb1-u01-l02'],
  },
  {
    exerciseId: 'kb1-u01-l02-ex-08b-orange',
    lessonId: 'kb1-u01-l02',
    order: 8,
    pageRef: 'PB p.6',
    textbookActivityType: KidsTextbookActivityType.LISTEN_AND_REPEAT,
    studentActionType: KidsStudentActionType.REPEAT_WORD,
    targetItemIds: ['KB1-U01-COL-005'],
    teacherInstruction: 'Listen. Orange. Say orange!',
    prompt: { text: 'Listen — orange! Now you!', ttsText: 'Listen — orange! Now you say it!' },
    choices: [],
    expectedAnswers: ['orange'],
    audioPromptPayload: {
      assets: [{ assetId: 'kb1-u01-colour-orange-tts', assetType: 'tts_prompt', available: true }],
    },
    completionRule: {
      type: KidsCompletionRuleType.CORRECT_REPETITIONS,
      requiredCorrectCount: 2,
    ...
    requiresVisualUI: false,
    allowedWithoutVisualUI: true,
    tags: ['listen-and-repeat', 'colour-orange', 'unit1', 'kb1-u01-l02'],
  },
  {
  ...
  },
  {
    ...
    nextExerciseId: 'kb1-u01-l02-ex-09b-choose-pair-3',
    requiresVisualUI: false,
    allowedWithoutVisualUI: true,
    tags: ['listen-and-choose', 'colour-pink', 'colour-purple', 'unit1', 'kb1-u01-l02'],
  },
  {
    exerciseId: 'kb1-u01-l02-ex-09b-choose-pair-3',
    lessonId: 'kb1-u01-l02',
    order: 11,
    pageRef: 'PB p.7',
    textbookActivityType: KidsTextbookActivityType.LISTEN_AND_CHOOSE,
    studentActionType: KidsStudentActionType.SAY_CHOICE,
    targetItemIds: ['KB1-U01-COL-006', 'KB1-U01-COL-005'],
    teacherInstruction: 'Red or orange? Which one?',
    prompt: { text: 'Red or orange?', ttsText: 'Red or orange? Which colour is it?' },
    choices: [
      { choiceId: 'choice-red', text: 'red' },
      { choiceId: 'choice-orange', text: 'orange' },
    ],
    expectedAnswers: ['red'],
    audioPromptPayload: {
      assets: [{ assetId: 'kb1-u01-colour-red-tts', assetType: 'tts_prompt', available: true }],
    ...
    requiresVisualUI: false,
    allowedWithoutVisualUI: true,
    tags: ['listen-and-choose', 'colour-red', 'colour-orange', 'unit1', 'kb1-u01-l02'],
  },
  {
