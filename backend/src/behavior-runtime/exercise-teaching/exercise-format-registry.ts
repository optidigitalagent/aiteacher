...
const REGISTRY: Record<string, ExerciseFormatPolicy> = {
  ...
  gapped_text: {
    ...
    instructionPolicy: {
      openingTemplate: 'Exercise {N} — gapped text. Sentences A-F are on screen. I\'ll ask you which sentence fits each gap in the text.',
      answerFormatSpec: 'Say the letter of the sentence that fits — A, B, C, D, E, or F.',
      exampleScript: 'For example: if gap 1 needs a sentence about teenagers being active, you look at which sentence fits that meaning and say the letter.',
      briefRepeatReminder: 'Same format — look at the text, pick the sentence letter.',
      forbiddenAtIntro: [
        'Do not read all six sentences aloud — they are visible on screen.',
        'Do not reveal which letter is correct before the student attempts.',
        'Do not reference options not shown on screen.',
      ],
    },
    demonstrationPolicy: {
      required: false,
      maxExamples: 1,
      exampleRule: 'Describe the process only — do not use the actual gap items as examples.',
      whenToSkipDemo: 'Skip if student is familiar with gapped text format.',
      antiPatterns: ['Do not pre-solve any gap.'],
    },
    expectedAnswerPolicy: {
      format: 'letter_choice',
      answerDescription: 'A letter from A to F.',
      partialAnswerRule: 'If student says the full sentence text, accept it and confirm the matching letter.',
      voiceAdaptation: 'Accept spoken letter — STT may hear "A" as "ay" or "eight", normalize as needed.',
    },
    hintPolicy: {
      turnA: 'Ask the student to look at the gap context: "What kind of idea is missing there — positive or negative? Look at the sentences on screen — which matches?" Give no answer.',
      turnB: 'Narrow the choices: "Can you rule out any letters? Which ones clearly don\'t fit?"',
      turnC: 'Give a stronger hint about the theme: "The missing sentence is about [theme]. Which letter has that theme?"',
      turnD: 'REVEAL: "The correct answer is [letter]. Let\'s move to the next gap." Ask student to confirm.',
      revealOnTurn: 'D',
    },
    retryPolicy: { maxRetries: 3, requireRepeatAfterReveal: false, escalationNotes: ['Guide by meaning, not by elimination alone.'] },
    frontendRenderPolicy: {
      itemsVisible: true,
      optionsVisible: true,
      wordBoxVisible: false,
      ...
      doNotRereadOptions: true,
      referenceByNumber: true,
      screenAwarenessNote: 'Sentences A-F are visible on screen. Do NOT read them all aloud. Student can see them.',
    },
  },
  ...
  find_in_text: {
    ...
    runtimeMode: 'reading_text',
    instructionPolicy: {
      openingTemplate: 'Exercise {N} — find words or phrases in the text. I\'ll tell you what to look for.',
      answerFormatSpec: 'Say the word or phrase you find in the text.',
      exampleScript: 'For example: if I ask for a word meaning "happy" — look in the text and say the exact word you find.',
      briefRepeatReminder: 'Find the exact word or phrase in the text.',
      forbiddenAtIntro: ['Do not give the answer before the student looks.'],
    },
    demonstrationPolicy: {
      required: false,
      maxExamples: 1,
      exampleRule: 'Use a different example from the actual items.',
      whenToSkipDemo: 'Skip if type is clear to student.',
      antiPatterns: ['Do not reveal the answer in the demo.'],
    },
    expectedAnswerPolicy: {
      format: 'word_or_phrase',
      answerDescription: 'Exact word or phrase from the text.',
    ...
    frontendRenderPolicy: {
      ...
      doNotRereadOptions: false,
      referenceByNumber: true,
      screenAwarenessNote: 'Items are visible. Student reads from their textbook to find answers.',
    },
  },
  ...
  read_and_answer: {
    ...
    runtimeMode: 'reading_text',
    instructionPolicy: {
      openingTemplate: 'Exercise {N} — read and answer. I\'ll ask you questions about the text.',
      answerFormatSpec: 'Answer based on what you read. A short phrase or sentence is fine.',
      exampleScript: 'For example: if I ask "Who wrote the article?" — look in the text and tell me the name.',
      briefRepeatReminder: 'Answer based on the text you read.',
      forbiddenAtIntro: ['Do not give answers before the student attempts.'],
    },
    demonstrationPolicy: {
      required: false,
      maxExamples: 1,
      exampleRule: 'Use a different example question from the actual items.',
      whenToSkipDemo: 'Usually skip — just launch the first question.',
      antiPatterns: ['Do not model the answer to item 1.'],
    },
    expectedAnswerPolicy: {
      format: 'word_or_phrase',
      answerDescription: 'A short answer based on the text.',
      partialAnswerRule: 'Accept partial answers and ask for the key detail if missing.',
      voiceAdaptation: 'Accept spoken answer — STT may miss articles or connectors.',
    },
    hintPolicy: {
      ...SOFT_HINT,
      turnA: 'Tell the student which part of the text to re-read: "Look at paragraph [N] — what does it say about [topic]?"',
      turnB: 'Give a stronger pointer: "The answer is in the sentence that mentions [clue]."',
    },
    retryPolicy: SOFT_RETRY,
    frontendRenderPolicy: {
      itemsVisible: true,
      ...
      doNotRereadOptions: false,
      referenceByNumber: true,
      screenAwarenessNote: 'Questions are visible. Student reads from textbook to answer.',
    },
  },
  ...
  read_and_write_names: {
    ...
    runtimeMode: 'reading_text',
    instructionPolicy: {
      openingTemplate: 'Exercise {N} — read and say the name. I\'ll read a description and you tell me who it matches.',
      answerFormatSpec: 'Say the name of the person described.',
      exampleScript: 'For example: if I say "Who thinks hobbies are important?" — look in the text and say the person\'s name.',
      briefRepeatReminder: 'Say the name that matches the description.',
      forbiddenAtIntro: ['Do not give names before the student attempts.'],
    },
    demonstrationPolicy: {
      required: false,
      maxExamples: 1,
      exampleRule: 'Use a simple example with a different name.',
      whenToSkipDemo: 'Skip if format is clear.',
      antiPatterns: ['Do not reveal the name for item 1.'],
    },
    expectedAnswerPolicy: {
      format: 'word_or_phrase',
      answerDescription: 'A person\'s name.',
      partialAnswerRule: 'Accept approximate pronunciation — confirm the correct name.',
      voiceAdaptation: 'Accept spoken name — STT may mis-transcribe names.',
    },
    hintPolicy: {
      ...DETERMINISTIC_HINT,
      turnA: 'Tell the student which section of the text to look at: "Look at the comment that mentions [clue]. Who wrote that?"',
      turnB: 'Give a stronger hint: "The person who [key detail] — what is their name?"',
    },
    retryPolicy: DETERMINISTIC_RETRY,
    frontendRenderPolicy: {
      itemsVisible: true,
      ...
      doNotRereadOptions: false,
      referenceByNumber: true,
      screenAwarenessNote: 'Questions are visible. Student reads from textbook to find names.',
    },
  },
  ...
  phrase_classification: {
    ...
    runtimeMode: 'reading_text',
    instructionPolicy: {
      openingTemplate: 'Exercise {N} — classify the phrases. The phrases are on screen. I\'ll ask about one phrase at a time.',
      answerFormatSpec: 'Say which category the phrase belongs to — for example "Parents say" or "Teenagers say".',
      exampleScript: 'For example: if the phrase is "obsessed with phones" — would parents or teenagers say this about teenagers? You say the category.',
      briefRepeatReminder: 'Say which category fits the phrase.',
      forbiddenAtIntro: [
        'Do not read out all the phrases — they are visible on screen.',
        'Do not reveal the category before the student answers.',
      ],
    },
    demonstrationPolicy: {
      required: true,
      maxExamples: 1,
      exampleRule: 'Use a different phrase from the actual items as the demo.',
      whenToSkipDemo: 'Skip if student has seen this type before.',
      antiPatterns: ['Do not use item 1 as the demo.'],
    },
    expectedAnswerPolicy: {
      format: 'word_or_phrase',
      answerDescription: 'The category name.',
      partialAnswerRule: 'Accept partial answers — confirm the correct category.',
      voiceAdaptation: 'Accept "parents" or "teenagers" without the full phrase.',
    },
    hintPolicy: {
      turnA: 'Ask a guiding question: "Is this phrase positive or negative? Who is more likely to use it?" Give no answer.',
      turnB: 'Give a context hint: "Think about who says teenagers are lazy — parents or teenagers themselves?"',
      turnC: 'Give a strong hint: "This is a [positive/negative] quality — which group claims this?"',
      turnD: 'REVEAL: "The correct category is [answer]. Let\'s move to the next phrase." Ask student to confirm.',
      revealOnTurn: 'D',
    },
    retryPolicy: DETERMINISTIC_RETRY,
    frontendRenderPolicy: {
      ...
      doNotRereadOptions: true,
      referenceByNumber: true,
      screenAwarenessNote: 'Phrases and categories are visible on screen. Do NOT read all phrases aloud.',
    },
  },
}
