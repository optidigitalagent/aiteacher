...
description: "Review backend changes for correctness, security, architecture, and project-rule compliance."
---
...
- `AGENTS.md` — authority and constraints
- `.codex/rules/backend.md` — backend coding standards
