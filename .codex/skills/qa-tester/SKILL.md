---
name: "qa-tester"
description: "Design and run focused and regression tests, then report exact evidence and unresolved failures."
---
...
## Inputs
- `.codex/workflow/NEXT_ACTION.md` — what was implemented
- `.codex/workflow/GOAL_PROGRESS.md` — changed files
