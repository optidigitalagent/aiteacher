...
|--------------------|-------------------------------------------|----------------------------|
| `auto-qa-loop`     | `.claude/agents/auto-qa-loop/AGENT.md`    | PASS / FAIL + авто-фикс    |
| `backend-reviewer` | `.claude/agents/backend-reviewer/AGENT.md`| PASS / NEEDS_CHANGES       |
| `lesson-qa`        | `.claude/agents/lesson-qa/AGENT.md`       | PASS / FAIL                |
| `migration-guard`  | `.claude/agents/migration-guard/AGENT.md` | SAFE / UNSAFE              |
| `env-checker`      | `.claude/agents/env-checker/AGENT.md`     | READY / NOT_READY          |
| `prompt-tester`    | `.claude/agents/prompt-tester/AGENT.md`   | PASS / FAIL                |
| `latency-profiler` | `.claude/agents/latency-profiler/AGENT.md`| НОРМА / ПРЕВЫШЕНИЕ         |
| `rag-auditor`      | `.claude/agents/rag-auditor/AGENT.md`     | GOOD / DEGRADED / BROKEN   |
| `completion-analyzer` | `.claude/agents/completion-analyzer/AGENT.md` | Completion Rate + фаза |
| `lesson-critic`    | `.claude/agents/lesson-critic/AGENT.md`   | Quality Score              |
| `api-cost-estimator` | `.claude/agents/api-cost-estimator/AGENT.md` | Расходы + маржа        |
| `kids-safety-monitor` | `.claude/agents/kids-safety-monitor/AGENT.md` | OK / INCIDENT          |
